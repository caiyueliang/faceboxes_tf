...
class FaceBox(object):
    ...
    def build_graph(self, DEBUG=False):
        ...
        if DEBUG:
            print('Input shape: ', self.inputs.get_shape())
        ...
        if DEBUG:
            print('Conv 1 shape: ', conv_1_pool.get_shape())
        ...
        if DEBUG:
            print('Conv 2 shape: ', conv_2_pool.get_shape())

        print('Building Inception...')
        incept_1 = self.Inception(conv_2_pool, 'inception_1')
        if DEBUG:
            print('Incept 1 shape: ', incept_1.get_shape())
        incept_2 = self.Inception(incept_1, 'inception_2')
        if DEBUG:
            print('Incept 2 shape: ', incept_2.get_shape())
        incept_3 = self.Inception(incept_2, 'inception_3')
        if DEBUG:
            print('Incept 3 shape: ', incept_3.get_shape())
        
        if DEBUG:
            print('Inception 3 anchors...')
        ...
        conv_3_1 = tf.layers.conv2d(incept_3, 128, 
                                ...
                                padding = 'SAME')
        if DEBUG:
            print('Conv 3_1 shape: ', conv_3_1.get_shape())
        ...
        if DEBUG:
            print('Conv 3_2 anchors...')
        l, c = self.build_anchor(conv_3_2, 1, 'anchor_conv_3_2')
        bbox_locs.append(l)
        bbox_confs.append(c)

        if DEBUG:
            print('Conv 3_2 shape: ', conv_3_2.get_shape())
        conv_4_1 = tf.layers.conv2d(conv_3_2, 128, 
                                ...
                                padding = 'SAME')
        if DEBUG:
            print('Conv 4_1 shape: ', conv_4_1.get_shape())
        ...
        conv_4_2 = tf.layers.conv2d(conv_4_1, 256, 
                                ...
                                padding = 'SAME')
        if DEBUG:
            print('Conv 4_2 shape: ', conv_4_2.get_shape())

        if DEBUG:
            print('Conv 4_2 anchors...')
